...
[DEAD] = LAYOUT(                                                        \
  TAB,    KC_Q,   KC_W,   KC_1,   KC_R,        KC_1,   KC_2,   KC_3,   KC_4,   ESC,     \
  SFT,    KC_A,   KC_S,   KC_D,   KC_F,        KC_G,   XXXXX,  XXXXX,  XXXXX,  XXXXX,     \
  ESC,    KC_2,   KC_3,   KC_4,   KC_B,        KC_Z,   KC_X,   KC_C,   KC_V,  DQG,   \
                  GALT,   GCTL,   KC_SPC,      KC_B,   KC_J,   KC_T                      \
),
