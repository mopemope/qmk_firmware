...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------|              |------+------+------+------+------+------|
     KDOWN , KC_A , KC_R , KC_S , KC_T , KC_D ,                KC_H , KC_N , KC_E , KC_I , O_M  , KUP  ,
  //|------+------+------+------+------+------+------. ,-----|------+------+------+------+------+------|
     KLEFT , KC_Z , KC_X , KC_C , KC_V , KC_B ,  RAI ,   LOW ,KC_K  , KC_M , COMM , DOT  , S_M  ,KRIGHT,
  //`------+------+------+------+------+------+------/ \-----+------+------+------+------+------+------'
  ...
  [EMACS2] = KEYMAP(
  //,------+------+------+------+------+------.              ,------+------+------+------+------+------.
     RESET ,______,______,______,______,______,               ______,______,______,______,______,RESET ,
  //|------+------+------+------+------+------|              |------+------+------+------+------+------|
     ______,______, M_W ,  C_F  , C_Y  , C_G  ,               M_DOT , ELT  , C_P  , E_GT ,______,______,
  //|------+------+------+------+------+------|              |------+------+------+------+------+------|
     ______, C_A  , C_R  , C_S  , C_T  , C_AT ,               M_PER , C_LE , C_N  , C_RI ,______,______,
  //|------+------+------+------+------+------+------. ,-----|------+------+------+------+------+------|
     ______, C_Z  , C_X  , C_C  ,______, C_B  ,  SPC , ______, M_X  ,C_SCLN,C_COLN,C_PIPE,M_SCLN,______,
  //`------+------+------+------+------+------+------/ \-----+------+------+------+------+------+------'
  ...
  //|------+------+------+------+------+------+------. ,-----|------+------+------+------+------+------|
     ______,______,______, LPRN , RPRN , BSLS , GUI  , ______, CIRC , MINS , SCLN , DOT  , PLUS ,______,
  //`------+------+------+------+------+------+------/ \-----+------+------+------+------+------+------'
                                 ______, ZHTG , GUI  , ______,______, ALT
  //                            `------+------+------' `-----+------+------'
  ),
  ...
  //|------+------+------+------+------+------+------. ,-----|------+------+------+------+------+------|
     ______, UNDS ,KC_F7 ,KC_F8 ,KC_F9 ,KC_F10,______, ______,KC_F11,KC_F12, LPRN , RPRN , MINS ,______,
  //`------+------+------+------+------+------+------/ \-----+------+------+------+------+------+------'
                                 ______,______,______,  GUI  , ZHTG , ALT
  //                            `------+------+------' `-----+------+------'
  ),
  ...
  //,------+------+------+------+------+------.              ,------+------+------+------+------+------.
     RESET ,______,______,______,______,______,               ______,______,______,______,______,RESET ,
  //|------+------+------+------+------+------|              |------+------+------+------+------+------|
     ______,RESET , WH_D , MS_U , WH_U ,WRKSP1,               UWRKSP, PGDN , KUP  , PGUP ,RESET ,______,
  //|------+------+------+------+------+------|              |------+------+------+------+------+------|
     ______,______, MS_L , MS_D , MS_R ,WRKSP2,               DWRKSP,KLEFT ,KDOWN ,KRIGHT,______,______,
  //|------+------+------+------+------+------+------. ,-----|------+------+------+------+------+------|
  ...
  //,------+------+------+------+------+------.              ,------+------+------+------+------+------.
     RESET ,______,______,______,______,______,               ______,______,______,______,______,RESET ,
  //|------+------+------+------+------+------|              |------+------+------+------+------+------|
     ______,RESET ,______,______,______,______,               ______,______,  GU  ,______,RESET ,______,
  //|------+------+------+------+------+------|              |------+------+------+------+------+------|
