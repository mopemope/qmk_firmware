...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------+------. ,-----|------+------+------+------+------+------|
     KLEFT , Z_M  , KC_X , KC_C , KC_V , KC_B ,  RAI ,   LOW ,KC_K  , KC_M , COMM , DOT  , S_M  ,KRIGHT,
  //`------+------+------+------+------+------+------/ \-----+------+------+------+------+------+------'
  ...
  //|------+------+------+------+------+------+------. ,-----|------+------+------+------+------+------|
     ______,______,______, LPRN , RPRN , BSLS , ZHTG , ______, CIRC , MINS , SCLN , DOT  , PLUS ,______,
  //`------+------+------+------+------+------+------/ \-----+------+------+------+------+------+------'
                                 ______,______, GUI  , ______,______, ALT
  //                            `------+------+------' `-----+------+------'
  ),
  ...
  //|------+------+------+------+------+------+------. ,-----|------+------+------+------+------+------|
     ______, UNDS ,KC_F7 ,KC_F8 ,KC_F9 ,KC_F10,______,  ZHTG ,KC_F11,KC_F12, LPRN , RPRN , MINS ,______,
  //`------+------+------+------+------+------+------/ \-----+------+------+------+------+------+------'
                                 ______,______,______,  GUI  ,______, ALT
  //                            `------+------+------' `-----+------+------'
  ),
