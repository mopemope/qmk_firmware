...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------+------. ,-----|------+------+------+------+------+------|
      CTL  , Z_M  , KC_X , KC_C , KC_V , KC_B , ALT  ,   CTL , KC_K , KC_M , COMM , DOT  , S_M  ,SBSLS ,
  //`------+------+------+------+------+------+------/ \-----+------+------+------+------+------+------'
  ...
  //`------+------+------+------+------+------+------/ \-----+------+------+------+------+------+------'
                                  ZHTG ,______, GUI  , ______,______, ALT
  //                            `------+------+------' `-----+------+------'
  ),
  ...
  //|------+------+------+------+------+------+------. ,-----|------+------+------+------+------+------|
     ______,______,______, COPY ,PASTE , GUI  , GUI ,    GUI , DC   , DE   ,XXXXXX,XXXXXX,XXXXXX,______,
  //`------+------+------+------+------+------+------/ \-----+------+------+------+------+------+------'
