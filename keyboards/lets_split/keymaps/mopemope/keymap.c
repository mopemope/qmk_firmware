...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [EMACS2] = KEYMAP( \
    ...
    _______, CZ,      CX,      CC,      _______, CB,      M_PER,   M_X,      CCOLN,   CPIPE,    _______, _______, \
  ...
  [LOWER] = KEYMAP( \
    ...
    RESET,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    JP_TILD, JP_EQL,  JP_COLN, KC_DOT,  JP_ASTR, JP_YEN,  \
    _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    JP_CIRC, JP_MINS, JP_SCLN, JP_SLSH, JP_PLUS, _______, \
