...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [QGMLWY] = LAYOUT( \
     ...
     TAB,    GCTL,   ESC,    GCTL,   GALT,  SPC,         ENT,    BSPC,   GALT,   ESC,    TAB,    GUI     \
  ),
  ...
  [COD] = LAYOUT( \
    ...
    GCTL,   KC_K,   KC_M,   KC_X,   KC_G,                        KLEFT,  KUP,    KDOWN,  KRIGHT, KC_T,    \
  ...
  [SF6] = LAYOUT( \
    ...
    TAB,    XXXXXX, XXXXXX, ESC,    KC_B,   KC_W,       KC_H,    KC_P,   ALTZ,   REC,    DQG,    XXXXXX      \
  ),
