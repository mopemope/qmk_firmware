...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |      |      |      |      |      |      |             |      |      |      |      |      |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      | M-W  | C-F  | C-Y  | C-G  |             | M-.  | E-LT |  UP  | E-GT |      |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
  ...
  [EMACS2] = KEYMAP( \
      ...
      ____,  ____,  M_W,    C_F,   C_Y,   C_G,                 M_DOT, ELT,   C_P,    EGT,   ____,   ____, \
      ____,  C_A,   C_R,    C_S,   C_T,   C_AT,                M_PER, C_LE,  C_N,    C_RI,  C_M_S,  ____, \
  ...
  [MISC] = KEYMAP( \
      ...
      ____,  ____,  ____,  COPY,  PASTE, GH,    ____,   ____, DC,     DE,    ASTG,  ____,  ____,  ____,  \
